...
xtquant-proxy is a Python proxy service that wraps the QMT xtquant SDK, exposing quantitative trading data and trading functions through REST API, gRPC, and WebSocket interfaces. The project targets Windows (QMT requirement) with Python 3.12+.
